######################################
Right Flank Bomb H [Custom Robo Battle Revolution]
######################################
.alias PartType = 0x02
.alias PartBase = 0x07
.alias ModelID = 0x07
...
PartName:
    String|
"Right Flank Bomb H (CRBR)"
PartDescription:
    String|
"Launches right then turns 
left. 
Blows target slowly 
sideways. 
...
##### First Ground Bomb #####
half [4] |
65452, | #Left / Right Lnading Displacment 
...
##### First Ground Bomb #####
half [4] |
70, | #Left / Right Lnading Displacment 
0, | #Front / Back Landing Displacment 
60, | #Vertical Arc Angle 
